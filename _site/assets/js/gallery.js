...
// @downloadURL http://localhost:4000/assets/js/gallery.js
// @updateURL   http://localhost:4000/assets/js/gallery.js
// @homepageURL http://localhost:4000
// @icon        http://localhost:4000/assets/logo/letters_logo.svg
// @run-at      document-end
// ==/UserScript==
...
mediaGallery({
 //mediaSelectors: [{selector: 'img', attr: 'src' }],
